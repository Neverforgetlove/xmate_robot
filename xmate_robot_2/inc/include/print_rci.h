...
inline std::ostream &operator<<(std::ostream &ostream, const RCI::robot::RobotState &robot_state) {
    ostream << "{\"q\": " << robot_state.q << ", \"q_c\": " << robot_state.q_c << ", \"dq_m\": " << robot_state.dq_m
            << ", \"dq_c\": " << robot_state.dq_c << ", \"ddq_c\": " << robot_state.ddq_c
            << ", \"toolTobase_pos_m\": " << robot_state.toolTobase_pos_m
            << ", \"toolTobase_pos_c\": " << robot_state.toolTobase_pos_c
            << ", \"toolTobase_vel_c\": " << robot_state.toolTobase_vel_c
            << ", \"toolTobase_acc_c\": " << robot_state.toolTobase_acc_c << ", \"psi_m\": " << robot_state.psi_m
            << ", \"psi_c\": " << robot_state.psi_c << ", \"psi_vel_c\": " << robot_state.psi_vel_c
            << ", \"psi_acc_c\": " << robot_state.psi_acc_c << ", \"tau_m\": " << robot_state.tau_m
            << ", \"tau_m_filtered\": " << robot_state.tau_m_filtered << ", \"tau_c\": " << robot_state.tau_c
            << ", \"tau_vel_c\": " << robot_state.tau_vel_c << ", \"tau_ext_in_base\": " << robot_state.tau_ext_in_base
            << ", \"tau_ext_in_stiff\": " << robot_state.tau_ext_in_stiff << ", \"theta_m\": " << robot_state.theta_m
            << ", \"theta_vel_m\": " << robot_state.theta_vel_m << ", \"motor_tau\": " << robot_state.motor_tau
            ...
            << ", \"motion_generator_mode\": " << robot_state.motion_generator_mode
            << ", \"controller_mode\": " << robot_state.controller_mode
...
inline std::ostream &operator<<(std::ostream &ostream, const RCI::robot::RobotCommand &robot_command) {
    ostream << "{\"q_c\": " << robot_command.motion.q_c
            << ", \"toolTobase_pos_c\": " << robot_command.motion.toolTobase_pos_c
            << ", \"psi_vaild\": " << robot_command.motion.psi_valid << ", \"psi_c\": " << robot_command.motion.psi_c
            << ", \"motion_generation_finished\": " << robot_command.motion.motion_generation_finished
            << ", \"tau_c\": " << robot_command.torque.tau_c << "}";
    return ostream;
}
}  // namespace xmate