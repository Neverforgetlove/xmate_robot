...
bool grasp_push_actionid2(double& graspid2_x, double& graspid2_y, double& graspid2_z){
    ...
    current_pose.pos = robot_state.toolTobase_pos_m;
    end_pose.pos  = robot_state.toolTobase_pos_m;
    end_pose.pos[11] -= 0.025; // 增大往前(默认:0.11)
    MOVEL(0.3, current_pose, end_pose, robot);
...
/*-------------------------------------------------------*/
    ...
    do {
        ...
        do {
            ...
            Eigen::Quaterniond quaternion(ww2,wx2,wy2,wz2);
            //  四元数求欧拉角
        ...
        do {
            ...
            wz = arpose.print_datawz();
            //  机械臂平移
            grasp_move_xyz(sx, sy, sz, grasp_x, grasp_y, grasp_z);
            test_DO(0);
        } while (0);
    ...
    //  机械臂放置物料
    grasp_push_actionid2(graspid2_x, graspid2_y, graspid2_z); 
...
/*-------------------------------------------------------*/
    ...
    //  机械臂放置物料
    grasp_push_actionid1(graspid1_x, graspid1_y, graspid1_z); 
/*--------------------------------------------------------*/
