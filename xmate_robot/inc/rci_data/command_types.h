...
enum class Command : uint32_t {
    ...
    kSetCartesianLimit,      //设置拖动示教时的虚拟墙
...
struct StartMoveRequest {
    ...
    StartMoveRequest()
        : command(Command::kStartMove),
          control_mode(ControllerMode::kJointPosition),
          motion_mode(MotionGeneratorMode::kJointPosition) {}
