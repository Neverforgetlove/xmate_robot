...
inline void ToArray(Eigen::Matrix3d& rot_matrix,Eigen::Vector3d& p,std::array<double,16>& array){
    array = {{rot_matrix(0,0),rot_matrix(0,1),rot_matrix(0,2),p(0),
              rot_matrix(1,0),rot_matrix(1,1),rot_matrix(1,2),p(1),
              rot_matrix(2,0),rot_matrix(2,1),rot_matrix(2,2),p(2),
              0,0,0,1}};
}

inline void Matrix4dToArray(Eigen::Matrix4d& matrix,std::array<double,16>& array){
    array = {{matrix(0,0),matrix(0,1),matrix(0,2),matrix(0,3),
...
inline void ArrayTo(std::array<double,16>& array,Eigen::Matrix3d& rot_matrix,Eigen::Vector3d& p){
    rot_matrix << array[0],array[1],array[2],
                  array[4],array[5],array[6],
                  array[8],array[9],array[10];
    p << array[3],array[7],array[11];
}

inline void ArrayToMatrix4dToArray(Eigen::Matrix4d& matrix,std::array<double,16>& array){
    matrix <<  array[0],array[1],array[2],array[3], 
