 ...
 * 最大关节加加速度
 */
constexpr std::array<double, 7> kMaxJointJerk{{5000.0*deg2rad - kLimitEps, 5000.0*deg2rad - kLimitEps, 5000.0*deg2rad  - kLimitEps,
                                               5000.0*deg2rad  - kLimitEps, 7000.0*deg2rad  - kLimitEps, 7000.0*deg2rad  - kLimitEps,
                                               7000.0*deg2rad  - kLimitEps}};
/**
 * 最大关节加速度
 */
constexpr std::array<double, 7> kMaxJointAcceleration{{500.0*deg2rad  - kLimitEps, 500.0*deg2rad  - kLimitEps, 500.0*deg2rad  - kLimitEps,
                                                       500.0*deg2rad  - kLimitEps, 700.0*deg2rad  - kLimitEps, 700.0*deg2rad  - kLimitEps,
                                                       700.0*deg2rad  - kLimitEps}};
/**
 * 最大关节速度
 */
constexpr std::array<double, 7> kMaxJointVelocity{
    {180.0*deg2rad  - kLimitEps - kTolNumberPacketsLost * kDeltaT * kMaxJointAcceleration[0],
     180.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[1],
     180.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[2],
     180.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[3],
     225.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[4],
     225.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[5],
     225.0*deg2rad  - kLimitEps - kTolNumberPacketsLost* kDeltaT* kMaxJointAcceleration[6]}};
/**
 * 最大平移加加速度
 */
constexpr double kMaxTranslationalJerk = 10000.0*0.001 - kLimitEps;
/**
 * 最大平移加速度
 */
constexpr double kMaxTranslationalAcceleration = 5000.0*0.001 - kLimitEps;
/**
 * 最大平移速度
 */
constexpr double kMaxTranslationalVelocity =
    500.0*0.001 - kLimitEps - kTolNumberPacketsLost * kDeltaT * kMaxTranslationalAcceleration;
/**
 * 最大旋转加加速度
 */
constexpr double kMaxRotationalJerk = 3600.0*deg2rad - kLimitEps;
/**
 * 最大旋转加速度
 */
constexpr double kMaxRotationalAcceleration = 1800.0*deg2rad - kLimitEps;
/**
 * 最大旋转速度
 */
constexpr double kMaxRotationalVelocity =
    180.0*deg2rad - kLimitEps - kTolNumberPacketsLost * kDeltaT * kMaxRotationalAcceleration;
/**
 * 最大臂角加加速度
 */
constexpr double kMaxElbowJerk = 5000*deg2rad - kLimitEps;
/**
 * 最大臂角加速度
 */
constexpr double kMaxElbowAcceleration = 500*deg2rad - kLimitEps;
/**
 * Maximum 最大臂角速度
 */
